...
window.mobilecheck = function() {
  ...
  return check;
    ...
    document.write(unescape("%3Cscript src='" + p + "//crmt.cw.com.tw/SurveyCollector/scripts/preview.js?v=20190415012938' type='text/javascript'%3E%3C/script%3E"));
    document.write(unescape("%3Cscript src='" + p + "//crmt.cw.com.tw/SurveyCollector/info.ashx?clientID=cwmarketing&campaignID=MKOOFRMember&listID=6327&v=20190415012938' type='text/javascript'%3E%3C/script%3E"));            
    ...
    $(function()
    {            	
        $('#form').attr('action',location.protocol.replace('file:','http:') + '//crmt.cw.com.tw/SurveyCollector/sc.aspx');
        //$('form').live('keydown', function (e) { if (e.keyCode == 13) { e.preventDefault(); return false; } });
    });